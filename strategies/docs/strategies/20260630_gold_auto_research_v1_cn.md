...
desc: H1 4因子共识投票策略 + 高位拦截(price_position>0.82且偏离EMA21>2.5×ATR禁BUY) + 低位拦截(<0.18且偏离<−2.5×ATR禁SELL)
---
...
- 位置门禁：高位拦截（price_position>0.82 且偏离 EMA21>2.5×ATR 禁 BUY），低位拦截（<0.18 且偏离<−2.5×ATR 禁 SELL）
