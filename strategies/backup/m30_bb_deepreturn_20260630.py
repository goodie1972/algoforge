"""
M30 BB DeepReturn — 超跌reboundstrategy
===================================
...
class BBDeepReturnStrategy(BaseStrategy):
    ...
    def __init__(self, bridge: MT4BridgeBase, magic: int = 0, timeframe: str = ""):
        ...
        self.p_hard_atr = 2.0
        self.profit_drawdown_pct = 0.30  # BB reverse时 30% profitdrawdowntake profit
    ...
    def _calc_mfi_from(self, closes: list) -> Optional[float]:
        """用给定收盘价之前  K 线算 MFI（用于趋-trend比较）- 保留独有逻辑"""
        idx = len(closes) - 1
