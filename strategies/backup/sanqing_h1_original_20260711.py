...
================================
- 6因子Score + 固定threshold 4
- ATR动态trailing止损 trail=4.0 hard=2.5
- 无任何后加特性（无profitdrawdowntake profit、无保本出场、无Gate、无newsfilter）
...
STRATEGY_CHANGELOG = [
    ...
    {"version": "v1_original", "magic": 880101, "date": "2026-07-11", "desc": "restore原始v1代码，无任何后期modify，纯净运行"},
]

class SanQingEA_v1(BaseStrategy):
    """SanQing EA 原始v1version — 不做任何modify"""
    ...
    def __init__(self, bridge: MT4BridgeBase, magic: int = 0, timeframe: str = ""):
        ...
        self.p_hard_atr = 2.5
        self.adx_threshold = 20  # 仅用于Score提示，不做动态thresholdadjust
    ...
    def generate_signal(self) -> Optional[OrderType]:
        ...
        # 因子5: ATRvolatility（高波动时倾向with-trend）
    ...
    def check_ema20_exit(self, position, bid: float, ask: float) -> bool:
        """原始v1退出逻辑：纯ATRtrailingtake profit + 硬止损，无任何附加"""
